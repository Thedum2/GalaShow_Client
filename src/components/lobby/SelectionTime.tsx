...
const SelectionTime: React.FC<SelectionTimeProps> = ({
    ...
    <div className={`bg-black border-2 border-yellow-500 rounded-xl h-full min-h-0 p-4 flex flex-col justify-center gap-4 shadow-[0_0_15px_rgba(234,179,8,0.3)] overflow-hidden ${className}`}>
